...
<div class="container-fluid p-2 mt-2">
   <div class="row ">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="font-weight-bolder mb-0">Add Account Statement</h5>
            </p>
            <hr class="horizontal dark mt-2">
            <!-- deliveryorder add form started here  -->
            <form action="{{route('attachment.store1')}}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row ">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input  type="file" class="form-control " name="statement_doc" required>
