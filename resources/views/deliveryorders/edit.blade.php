                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="invoice_id" id="invoice_id" class="form-control multi-select" required>
                                ...
                                @foreach($invoices as $invoice)
                                 <option {{$deliveryOrder->invoice_id == $invoice->id ? 'selected' : ''}} value="{{$invoice->id}}">{{$invoice->invoiceId}}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                   <div class="col">
                       <label for="remarks">Remarks</label>
                        <textarea class="form-control" name="remarks">{{$deliveryOrder->remarks}}</textarea>
                   </div>
                </div>
