        ...
        <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">Amount</th>
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">DO No.</th>
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">DO Date</th>
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">Due Date</th>
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">DO Doc</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                    <td class="align-middle text-center">
                         &nbsp; <a class="dropdown-item" href="{{route('show_user_do',$deliveryorder->id)}}"><i class="fa fa-eye text-info" aria-hidden="true"></i></a> 
                  </td>
                  <td>
                    <div class="mx-3">
                  ...
                  <td>
                    <div class="mx-3">
                      <div class="flex-column text-center ">
                        <p class="text-xs text-secondary mb-0">{{$deliveryorder->customer_no}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="mx-3">
                      <div class="flex-column  text-center">
                        <p class="text-xs text-secondary mb-0">{{$deliveryorder->po_no}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="mx-3">
                      <div class="flex-column text-center ">
                        <p class="text-xs text-secondary mb-0">{{$deliveryorder->ref_no}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="mx-3">
                      <div class="flex-column  text-center">
                        <p class="text-xs text-secondary mb-0">{{$deliveryorder->amount}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="mx-3">
                      <div class="flex-column  text-center">
                        <p class="text-xs text-secondary mb-0">{{$deliveryorder->do_date}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="mx-3">
                      <div class="flex-column  text-center">
                        <p class="text-xs text-secondary mb-0">{{date_formatter($deliveryorder->date)}}</p>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div class="mx-3">
                      <div class="flex-column  text-center">
                        <p class="text-xs text-secondary mb-0"><a class="text-info"
