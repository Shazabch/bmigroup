                ...
                <div class="row ">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input value="{{$debitnote->customer_no}}" type="text" class="form-control" name="customer_no" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input value="{{$debitnote->po_no}}" type="text" class="form-control" name="po_no" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input value="{{$debitnote->amount}}" type="text" class="form-control" name="amount" required>
                ...
                <div class="row">
                   <div class="col">
                       <label for="remarks">Remarks</label>
                        <textarea class="form-control" name="remarks">{{$debitnote->remarks}}</textarea>
                   </div>
                </div>
