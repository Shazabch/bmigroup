    ...
    <div class="row ">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('customers.store1',$users->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="email2">Business E-mail 2 </label>
                                    <input type="email" value="{{$users->email2}}" class="form-control" name="email2" >
                                    <span class="text-danger text-sm ">@error('email') {{$message}} @enderror</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="email3">Business E-mail 3 </label>
                                    <input type="email" value="{{$users->email3}}" class="form-control" name="email3" >
                                    <span class="text-danger text-sm ">@error('email') {{$message}} @enderror</span>
                        ...
                        {{-- address --}}
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label for="company">Billing Address<span class="text-danger">*</span></label>
        ...
        <div class="col-3 col-lg-3">
            <div class="card card-body">
                <b class="text-dark text-center">Attachments</b>
                <hr class="text-dark">

                @foreach($attachments as $attach)
                    <span><a href="{{route('file.download',$attach->attachment)}}"><i class="fas fa-file-pdf text-lg me-1"></i></a> {{$attach->name}}</span>
                @endforeach
