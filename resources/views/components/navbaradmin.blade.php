...
<div class="fixed-plugin">
    ...
    <div class="card shadow-lg blur">
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <div class="mt-3">
        <a class="nav-link" href="{{route('upload.attachment')}}" class="nav-link " aria-controls="applicationsExamples" role="button" aria-expanded="false">
          <!-- <span class="nav-link-text ms-1">Change Password</span> -->
          <h6 class="mb-0">Upload Attachment (Customer)</h6>
        </a>
      </div>
      <div class="mt-3">
