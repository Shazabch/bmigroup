              ...
              <thead>
                <tr>
                 ...
                 <th class="text-dark opacity-7 text-center">Actions</th>
                  ...
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">CN No.</th>
                  <th class="text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">CN Date</th>
                  ...
                  <th class=" text-uppercase text-dark text-xxs font-weight-bolder opacity-7 text-center">CN Doc</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                         &nbsp; <a class="dropdown-item" href="{{route('show_user_cn',$creditnote->id)}}"><i class="fa fa-eye text-info" aria-hidden="true"></i></a> 
                  </td>
                  <td>
                    <div class="mx-3">
                  ...
                  <td>
                    <div class="mx-3">
                      <div class="flex-column text-center">
                        <p class="text-xs text-secondary mb-0"><a class="text-info" href="{{route('download_cn',$creditnote->id)}}">{{$creditnote->cn_doc}}</a></p>
                      </div>
                    </div>
                  </td>
